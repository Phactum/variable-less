...
/**
 * A service task may update the process entity and/or invoke external services
 * and wire results into the process entity in a way meaningful to it.
 *
 ...
 */
public abstract class SendTaskMultiInstance<P extends WorkflowAggregate, T> extends JavaDelegateTask<P>
